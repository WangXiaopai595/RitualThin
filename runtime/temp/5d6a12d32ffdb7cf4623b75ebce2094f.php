<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\www\RitualThin\public/../application/admin\view\banner\updatebanner.html";i:1541172278;s:59:"D:\www\RitualThin\application\admin\view\public\header.html";i:1517123229;s:59:"D:\www\RitualThin\application\admin\view\public\footer.html";i:1541171683;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<form class="layui-form" id="form">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block" style="width: 50%;">
			<input type="text" name="title" placeholder="" class="layui-input" value="<?php echo $banner['title']; ?>">
			<input type="hidden" name="id" placeholder="" class="layui-input" value="<?php echo $banner['id']; ?>">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block" style="width: 50%;">
			<img id="cover" style="width: 70px;height: 70px;" src="<?php echo $banner['path']; ?>" />
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block" style="width: 50%;">
			<input type="number" name="sort" autocomplete="off" placeholder="" class="layui-input" value="<?php echo $banner['sort']; ?>">
		</div>
		<div class="layui-form-mid layui-word-aux"></div>
	</div>
	...
	<div class="layui-form-item">
		<div class="layui-input-block">
			<button type="button" class="layui-btn" id="button" data-url='<?php echo url("banner/updatebanner"); ?>' data-succ='<?php echo url("banner/index"); ?>'>立即提交</button>
		</div>
	</div>
