<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\www\RitualThin\public/../application/admin\view\index\main.html";i:1541316599;s:59:"D:\www\RitualThin\application\admin\view\public\header.html";i:1517123229;s:59:"D:\www\RitualThin\application\admin\view\public\footer.html";i:1541171683;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
		...
		<div class="panel_box row">
			<div class="panel col">
				<a href="javascript:;">
					...
					<div class="panel_word userAll">
						<span><?php echo $total['user_today']; ?></span>
						<cite>今日新增用户</cite>
					</div>
				</a>
			</div>
			<div class="panel col max_panel">
				<a href="javascript:;">
					...
					<div class="panel_word allNews">
						<span><?php echo $total['rt_today']; ?></span>
						<em>今日新增礼薄</em>
					</div>
				</a>
			</div>
			<div class="panel col">
				<a href="javascript:;">
					...
					<div class="panel_word userAll">
						<span><?php echo $total['user_7']; ?></span>
						<cite>7日新增用户</cite>
					</div>
				</a>
			</div>
			...
			<div class="panel col">
				<a href="javascript:;">
					...
					<div class="panel_word userAll">
						<span><?php echo $total['user_30']; ?></span>
						<cite>30日新增用户</cite>
					</div>
				</a>
			</div>
			<div class="panel col max_panel">
				<a href="javascript:;">
					...
					<div class="panel_word allNews">
						<span><?php echo $total['rt_30']; ?></span>
						<em>30日新增礼薄</em>
					</div>
				</a>
			</div>
			...
			<div class="layui-inline">
				<form id="formData">
					<div class="layui-input-inline">
						<input type="text" class="layui-input" name="date_start" id="date_start">
					</div>—
					<div class="layui-input-inline">
						<input type="text" class="layui-input" name="date_end" id="date_end">
					</div>
					<button type="button" class="layui-btn search_btn" id="button" data-url="<?php echo url('index/search'); ?>">查询</button>
				</form>
			</div>
		</blockquote>
	...
	$("#button").click(function(){
		...
		$.ajax({
			...
			success:function(date){
				if(date.status == 1){
					$("#user").html(date.data.user);
					$("#rt").html(date.data.rt);
				}else{
