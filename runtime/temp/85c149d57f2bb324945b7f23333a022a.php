<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\www\RitualThin\public/../application/admin\view\group\index.html";i:1517189394;s:59:"D:\www\RitualThin\application\admin\view\public\header.html";i:1517123229;s:59:"D:\www\RitualThin\application\admin\view\public\footer.html";i:1517123802;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	...
	<div class="larry-personal">
		<div class="layui-tab">
			<blockquote class="layui-elem-quote news_search">
				...
				<?php if(in_array('group/addgroup',$operable)): ?>
					<div class="layui-inline">
						<a href="<?php echo url('group/addgroup'); ?>" class="layui-btn layui-btn-normal newsAdd_btn">添加菜单</a>
					</div>
				<?php endif; if(in_array('group/sort',$operable)): ?>
					<div class="layui-inline">
						<a data-url="<?php echo url('group/sort'); ?>" id="edit" class="layui-btn recommend" style="background-color:#5FB878">更新排序</a>
					</div>
				<?php endif; if(in_array('group/delete',$operable)): ?>
					<div class="layui-inline">
						<a data-url="<?php echo url('group/delete'); ?>" class="layui-btn layui-btn-danger batchDel">批量删除</a>
					</div>
				<?php endif; ?>
			...
			<div class="layui-form news_list">
				<table class="layui-table">
					...
					<tbody class="news_content">
						<?php if(is_array($group['list']) || $group['list'] instanceof \think\Collection || $group['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $group['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
							<tr>
								<td>
								...
								<td>
									<div class="layui-inline">
										...
										<input name="id" type="hidden" class="groupid" value="<?php echo $vo['id']; ?>" />
									</div>
								</td>
								<td class="status">
									<?php if(in_array('admin/delete',$operable)): if($vo['status'] == 1): ?>
											...
											<div data-url="<?php echo url('group/editstatus'); ?>" data-id="<?php echo $vo['id']; ?>" class="layui-unselect layui-form-switch layui-form-onswitch" lay-skin="_switch"><em>NO</em><i></i></div>
										<?php else: ?>
											<input name="show" lay-skin="switch" lay-text="NO|OFF" lay-filter="isShow" type="checkbox" value="0">
											<div data-url="<?php echo url('group/editstatus'); ?>" data-id="<?php echo $vo['id']; ?>" class="layui-unselect layui-form-switch" lay-skin="_switch"><em>OFF</em><i></i></div>
								...
								<td>
									<?php if(in_array('group/editgroup',$operable)): ?>
										<a href="<?php echo url('group/editgroup',array('id'=>$vo['id'])); ?>" class="layui-btn layui-btn-mini "><i class="iconfont icon-edit"></i> 编辑</a>
									<?php endif; if(in_array('group/delete',$operable)): ?>
										<a data-url="<?php echo url('group/delete'); ?>" data-id="<?php echo $vo['id']; ?>" class="layui-btn layui-btn-danger layui-btn-mini delete" data-id="1"><i class="layui-icon"></i> 删除</a>
									<?php endif; ?>
								</td>
							</tr>
